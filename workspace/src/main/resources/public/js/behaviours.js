...
/***/ function(module, exports, __webpack_require__) {
	...
	Behaviours.register('workspace', {
	    ...
	    loadResources: function (callback) {
	        entcore_1.http().get('/workspace/documents').done(function (documents) {
	            entcore_1.http().get('/workspace/documents?filter=protected').done(function (protectedDocuments) {
	                this.resources = underscore_1._.map(documents.concat(protectedDocuments), function (doc) {
	    ...
	    create: function (file, callback) {
	        ...
	        entcore_1.http().postFile('/workspace/document?protected=true&application=media-library', formData).done(function (data) {
	            file.loading = false;
	    ...
	    duplicate: function (file, visibility, callback) {
	        ...
	        xhr.onload = function (e) {
	            if (this.status == 200) {
	                ...
	                entcore_1.http().postFile('/workspace/document?' + visibility + '=true&application=media-library&' + entcore_1.workspace.thumbnails, formData).done(function (data) {
	                    if (typeof callback === 'function') {
	    ...
	    sniplets: {
	        documents: {
	            ...
	            controller: {
	                ...
	                updateSelection: function () {
	                    this.cursor.selection = underscore_1._.where(this.cursor.currentFolder.documents, { selected: true });
	                },
	                ...
	                addDocument: function (document) {
	                    ...
	                    Behaviours.applicationsBehaviours.workspace.loadResources(function (resources) {
	                        document = underscore_1._.findWhere(resources, { _id: document._id });
	                ...
	                dropTo: function (targetItem, $originalEvent) {
	                    ...
	                    var foundItem = underscore_1._.find(this.cursor.currentFolder.documents, function (document) {
	                ...
	                removeDocuments: function (document) {
	                    this.cursor.currentFolder.documents = underscore_1._.reject(this.cursor.currentFolder.documents, function (doc) {
	                        return doc.selected;
	                    });
	                    this.cursor.selection = [];
	                    if (typeof this.snipletResource.save === 'function') {
	                ...
	                getReferencedResources: function (source) {
	                    return underscore_1._.map(underscore_1._.filter(source.documents, function (doc) { return doc.icon; }), function (doc) {
	        ...
	        carousel: {
	            ...
	            controller: {
	                ...
	                init: function () {
	                    entcore_1.http().get('/workspace/documents', { filter: 'owner' }).done(function (data) {
	                        this.documents = data;
	                        this.$apply();
	                    }.bind(this));
	                },
	                ...
	                removeDocument: function (document) {
	                    this.source.documents = underscore_1._.reject(this.source.documents, function (doc) {
	                ...
	                getReferencedResources: function (source) {
	                    return underscore_1._.map(source.documents, function (doc) {
	                        var spl = doc.icon.split('/');
	                        return spl[spl.length - 1];
	                    });
	                }
